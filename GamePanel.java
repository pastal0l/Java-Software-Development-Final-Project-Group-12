...
public class GamePanel extends JPanel implements ActionListener {
    ...
    private void generateRandomMap() {
        ...
        // Ensure the start, exit, and monster spawn positions are always empty.
        // The door itself lives on the boundary at (19,19); only one adjacent interior tile is open.
        map[startTileY][startTileX] = 0;
        map[exitTileY][exitTileX] = 0;
        map[exitTileY][exitTileX - 1] = 0; // entrance from the left
